...
const { parse_input_output } = require('../scripts/settings/01-parse-config/03-parse-input-output');
const { configure_modes } = require('../scripts/settings/01-parse-config/04-configure-modes');
const {
  configure_processing,
} = require('../scripts/settings/01-parse-config/05-configure-processing');
const { configure_logging } = require('../scripts/settings/01-parse-config/06-configure-logging');
const { configure_media } = require('../scripts/settings/01-parse-config/07-configure-media');
const { configure_themes } = require('../scripts/settings/01-parse-config/08-configure-themes');
