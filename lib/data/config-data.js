 ...
 *
 * @typedef {Object<string,ParsedTheme>} ParsedThemes
 */
 ...
 * @prop {object} copy
 * @prop {string} copy.size
 * @prop {string | number} copy.line_height
 * @prop {object} h6
 * @prop {string} h6.size
