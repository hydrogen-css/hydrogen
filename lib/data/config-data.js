 ...
 * @prop {Color[]} [colors]
 * @prop {Wrapper[]} [containers] DEPRECATED
 * @prop {FontFamily[]} [fonts]
 * @prop {FontWeight[]} [font_weights]
 * @prop {Gradient[]} [gradients]
 * @prop {Radius[]} [radii]
 * @prop {Shadow[]} [shadows]
 * @prop {Transitions} [transitions]
 * @prop {Wrapper[]} [wrappers]
 *
 ...
 * @prop {string} key
 * @prop {object} default The theme settings for the default color mode
 * @prop {string} default.weight
 * @prop {object} [dark] The theme settings for dark mode
 * @prop {string} dark.weight
 */
/**
...
function get_default_config() {
  ...
  let defaults = {
    info: {
      ...
      roadmap: 'https://github.com/orgs/hydrogen-css/projects/3/views/3',
    ...
    media: {
      ...
      queries: [
        ...
        {
          key: 'l-tablet',
          query: '@media screen and (min-width: 73em)',
        },
        {
          key: 'laptop',
          query: '@media screen and (min-width: 80em)',
        },
        {
          key: 'desktop',
          query: '@media screen and (min-width: 100em)',
        },
      ],
    },
    /** @type {Theme[]} */
