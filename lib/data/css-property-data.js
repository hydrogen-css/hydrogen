 ...
 * @prop {ParsedAttributes} attributes During processing, this object is filled with attributes found in the user's input, along with the attributes parsed information
 */
/**
 * @typedef {Object<string,ParsedAttribute[]>} ParsedAttributes
 *
 ...
 * @prop {object} modifiers The parsed modifiers found inside the prefix
 * @prop {string} modifiers.media The media query modifier applied to this query
 * @prop {string} modifiers.theme The theme applied to this query (default if none specified)
 * @prop {"default" | "all" | "dark"} modifiers.mode The mode applied to this query (default if none specified)
 * @prop {string | null} modifiers.state The interaction state applied to this query
 * @prop {string[] | null} modifiers.selectors Selectors (ids, classes, attributes) that this query should target
 * @prop {string[] | null} modifiers.children Child elements that this query should target
