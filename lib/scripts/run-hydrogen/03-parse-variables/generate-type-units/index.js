 ...
 *
 * @param {ParsedConfig} settings The complete settings object
 * @param {ParsedTypography} type_config The target typography configuration being used to generate the type units
