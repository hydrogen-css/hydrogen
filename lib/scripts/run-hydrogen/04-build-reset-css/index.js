 ...
 */
function build_core_css(config, variables) {
  try {
    ...
    if (config.logging.generate_logs) {
      fs.writeFileSync(
        path.join(config.logging.directory + '/processed-settings.json'),
    ...
    if (config.processing.include_reset_css) {
      // Set font size, line height
      core_css =
        core_css +
        'html{font-size: var(--h2-base-font-size); line-height: var(--h2-base-line-height);}';
      // Reset body
      core_css = core_css + 'body {position: relative;-webkit-text-size-adjust:none;}';
      // Reset margins
      core_css =
        core_css +
      ...
      core_css =
        core_css +
        'button {font-family: inherit; font-size: var(--h2-font-size-body); line-height: var(--h2-line-height-body);}';
      core_css =
        core_css +
        'input {font-family: inherit; font-size: var(--h2-font-size-body); line-height: var(--h2-line-height-body);}';
      core_css =
        core_css +
        'select {font-family: inherit; font-size: var(--h2-font-size-body); line-height: var(--h2-line-height-body);}';
      core_css =
        core_css +
        'textarea {font-family: inherit; font-size: var(--h2-font-size-body); line-height: var(--h2-line-height-body);}';
      // Reset lists
      core_css =
      ...
      core_css =
        core_css +
        'caption, figcaption, label {font-size: var(--h2-font-size-caption);line-height: var(--h2-line-height-caption);}';
      // Body copy
      core_css =
        core_css +
        'p {font-size: var(--h2-font-size-body);line-height: var(--h2-line-height-body);}';
      // H6
      core_css =
