...
function configure_processing(defaults, config) {
  try {
    ...
    if (config.processing) {
      ...
      if (config.processing.error_recovery != undefined) {
        defaults.processing.error_recovery = config.processing.error_recovery;
      }
      if (config.processing.write_css_file != undefined) {
        defaults.processing.write_css_file = config.processing.write_css_file;
      }
    }
