...
const { validate_container_queries } = require('./07-container-queries');
const { validate_themes } = require('./08-themes');
              ...
              try {
                ...
                try {
                  ...
                  try {
                    ...
                    try {
                      if (config.container_queries) {
                        validate_container_queries(config);
                      }
                    } catch (error) {
                      error.errors.forEach((i) => {
                        errors = errors.concat({
