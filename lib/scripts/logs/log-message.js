 ...
 * @param {{type: "system" | "info" | "warning" | "error" | "success", message?: string, step?: string, attribute?: string, query?: string, css?: string, files?: string[]}} options Options passed to the message
 * @returns {boolean}
 */
