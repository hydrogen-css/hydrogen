...
var { setMarginMap } = require('../functions/map-margin');
...
function devSetHeadingLineHeights() {
  return setHeadingLineHeights(env);
}
...
function devSetMarginMap() {
  return setMarginMap(env);
}
