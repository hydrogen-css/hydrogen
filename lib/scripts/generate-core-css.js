...
function generateCoreCSS() {
  try {
    ...
    typographySettings.forEach(function (setting) {
      ...
      coreCSSString =
        coreCSSString + '--h2-base-line-height: ' + setting.lineHeight + ';';
      coreCSSString =
        coreCSSString + '--h2-base-whitespace: ' + setting.lineHeight + ';';
      // Captions
      coreCSSString =
      ...
      coreCSSString =
        coreCSSString + '--h2-line-height-h6: ' + setting.h6.lineHeight + ';';
      // H5
      coreCSSString =
        coreCSSString + '--h2-font-size-h5: ' + setting.h5.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h5: ' + setting.h5.lineHeight + ';';
      // H4
      coreCSSString =
        coreCSSString + '--h2-font-size-h4: ' + setting.h4.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h4: ' + setting.h4.lineHeight + ';';
      // H3
      coreCSSString =
        coreCSSString + '--h2-font-size-h3: ' + setting.h3.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h3: ' + setting.h3.lineHeight + ';';
      // H2
      coreCSSString =
        coreCSSString + '--h2-font-size-h2: ' + setting.h2.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h2: ' + setting.h2.lineHeight + ';';
      // H1
      coreCSSString =
        coreCSSString + '--h2-font-size-h1: ' + setting.h1.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h1: ' + setting.h1.lineHeight + ';';
