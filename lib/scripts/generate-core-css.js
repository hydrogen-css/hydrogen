...
function generateCoreCSS(argv) {
  try {
    ...
    typographySettings.forEach(function (setting) {
      ...
      coreCSSString = coreCSSString + '--h2-font-size-line-height: ' + setting.copy.lineHeight + ';';
      // H6
    ...
    if (settings.resetStyles != null && settings.resetStyles == true) {
      ...
      // Reset basic styles
      coreCSSString = coreCSSString + 'span {color: inherit;font-family: inherit;font-size: inherit;font-weight: inherit;line-height: inherit;}';
      coreCSSString = coreCSSString + 'em {color: inherit;font-family: inherit;font-size: inherit;font-style: italic;line-height: inherit;}';
      coreCSSString = coreCSSString + 'strong {color: inherit;font-family: inherit;font-size: inherit;font-weight: 600;line-height: inherit;}';
      coreCSSString = coreCSSString + 'a {color: inherit;font-family: inherit;font-size: inherit;font-weight: inherit;line-height: inherit;text-decoration: underline;}';
      // Reset lists
      ...
      // Copy
      coreCSSString = coreCSSString + 'p, div {font-size: var(--h2-font-size-copy);line-height: var(--h2-font-size-line-height);}';
      // H6
