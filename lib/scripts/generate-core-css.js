...
function generateCoreCSS() {
  try {
    ...
    typographySettings.forEach(function (setting) {
      ...
      // Base settings
      coreCSSString =
        coreCSSString + '--h2-base-font-size: ' + setting.htmlSize + ';';
      coreCSSString =
        coreCSSString + '--h2-base-line-height: ' + setting.line_height + ';';
      coreCSSString =
        coreCSSString + '--h2-base-whitespace: ' + setting.line_height + ';';
      // Captions
      coreCSSString =
        coreCSSString + '--h2-font-size-caption: ' + setting.caption.size + ';';
      coreCSSString =
        coreCSSString +
      ...
      // Copy
      coreCSSString =
        coreCSSString + '--h2-font-size-copy: ' + setting.copy.size + ';';
      coreCSSString =
        coreCSSString +
        '--h2-line-height-copy: ' +
      ...
      // H6
      coreCSSString =
        coreCSSString + '--h2-font-size-h6: ' + setting.h6.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h6: ' + setting.h6.line_height + ';';
      // H5
      coreCSSString =
        coreCSSString + '--h2-font-size-h5: ' + setting.h5.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h5: ' + setting.h5.line_height + ';';
      // H4
      coreCSSString =
        coreCSSString + '--h2-font-size-h4: ' + setting.h4.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h4: ' + setting.h4.line_height + ';';
      // H3
      coreCSSString =
        coreCSSString + '--h2-font-size-h3: ' + setting.h3.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h3: ' + setting.h3.line_height + ';';
      // H2
      coreCSSString =
        coreCSSString + '--h2-font-size-h2: ' + setting.h2.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h2: ' + setting.h2.line_height + ';';
      // H1
      coreCSSString =
        coreCSSString + '--h2-font-size-h1: ' + setting.h1.size + ';';
      coreCSSString =
        coreCSSString + '--h2-line-height-h1: ' + setting.h1.line_height + ';';
      ...
      if (settings.fonts != null) {
        settings.fonts.forEach(function (fontFamilySetting) {
          coreCSSString =
            coreCSSString +
            '--h2-font-family-' +
            fontFamilySetting.key +
            ': ' +
            fontFamilySetting.family +
            ';';
        });
      }
