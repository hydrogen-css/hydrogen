...
function generateCoreCSS(argv) {
  try {
    ...
    var h6LineHeight = calculateLineHeight(argv, h6Size);
    var h5Size = h6Size * fontScale;
    var h5Unit = h5Size + 'rem';
    var h5LineHeight = calculateLineHeight(argv, h5Size);
    var h4Size = h5Size * fontScale;
    var h4Unit = h4Size + 'rem';
    var h4LineHeight = calculateLineHeight(argv, h4Size);
    var h3Size = h4Size * fontScale;
    var h3Unit = h3Size + 'rem';
    var h3LineHeight = calculateLineHeight(argv, h3Size);
    var h2Size = h3Size * fontScale;
    var h2Unit = h2Size + 'rem';
    var h2LineHeight = calculateLineHeight(argv, h2Size);
    var h1Size = h2Size * fontScale;
    var h1Unit = h1Size + 'rem';
    var h1LineHeight = calculateLineHeight(argv, h1Size);
