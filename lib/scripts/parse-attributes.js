...
var { get_input_path } = require('./generate-paths');
...
function parse_input_data_for_attributes(settings, debug) {
  try {
    // Set up working data
    var user_input_paths_as_glob = get_input_path(settings, 'glob'); // Gets a glob version of the user's input paths
    var user_input_paths_as_array = get_input_path(settings, 'array'); // Gets an array version of the user's input paths
