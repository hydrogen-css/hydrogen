    ...
    load_configuration(argv, temp_logging)
      .then((user_config) => {
        ...
        if (
          !user_config.logging ||
          (user_config.logging &&
            user_config.logging.verbose &&
            user_config.logging.verbose === true)
        ) {
          log_message({
            type: 'system',
        ...
        validate_configuration(user_config, temp_logging)
          .then((validated_config) => {
            ...
            if (
              ...
              (validated_config.logging &&
                validated_config.logging.verbose &&
                validated_config.logging.verbose === true)
            ) {
              log_message({
                type: 'system',
            ...
            if (validated_config.processing) {
              ...
              if (validated_config.processing.prefixing != undefined) {
                processing_config.prefixing =
                  validated_config.processing.prefixing;
              }
            ...
            if (validated_config.logging) {
              ...
              if (validated_config.logging.verbose != undefined) {
                logging_config.verbose = validated_config.logging.verbose;
              }
            }
              ...
              validated_config.themes.forEach(function (theme) {
                ...
                if (theme.typography && theme.typography.length > 0) {
                  theme.typography.forEach(function (type_setting) {
                    ...
                    let numeric_line_height = parseFloat(
