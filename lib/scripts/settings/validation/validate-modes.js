    ...
    if (settings.modes.dark) {
      if (
        ...
        if (
          ...
          typeof settings.modes.dark.automatic_modifiers != 'boolean'
        ) {
          errors = errors.concat(
            new Error(
              'The "automatic_modifiers" option in the "modes" section of your configuration must either be "true" or "false".'
            )
          );
        }
        if (
