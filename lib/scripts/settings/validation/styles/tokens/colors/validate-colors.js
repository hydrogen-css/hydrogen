                ...
                if (Array.isArray(color_setting.modifiers) === false) {
                  ...
                  if (color_setting.modifiers.length != 0) {
                    color_setting.modifiers.forEach(function (
                      ...
                      // Validate self _________________________________________
                      // Type
                      if (typeof modifier_setting != 'object') {
                        ...
                        // Validate key ________________________________________
                        // Exists
                        ...
                        // Validate color ______________________________________
                        // Exists
