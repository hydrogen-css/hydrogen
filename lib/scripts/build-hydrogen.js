...
function get_queries(instance, property) {
  try {
    ...
    // console.log('get_queries attribute:'.bgGreen, attribute);
    //
    ...
    // Return the result =======================================================
    //
    // console.log('get_queries result'.bgGreen, result);
    return result;
  } catch (error) {
    //
    // Catch errors ============================================================
      ...
      hydrogen_attribute_data.properties.forEach(function (
        ...
        property_data.keys.forEach(function (attribute, attribute_index) {
          ...
          attribute.instances.forEach(function (instance, instance_index) {
            ...
            // console.log('attribute instance'.bgYellow, instance);
            ...
            if (values != null && values.length != 0 && values[0].length != 0) {
              ...
              values.forEach(function (value) {
                ...
                if (lint_parentheses(value) == false) {
                  ...
                  // console.log('target value:'.bgCyan, value);
                  var queryRegex = /[^(]+(?=\()/;
                  ...
                  if (mediaQuery == null) {
                    ...
                    // console.log('media query:'.bgCyan, mediaQuery);
                    ...
                    var final_class = '';
                    var final_children = [];
                    // console.log('media modifier array'.bgCyan, mediaModifiers);
                    mediaModifiers.forEach(function (modifier) {
                      ...
                      if (modifier.startsWith('class[') === true) {
                        ...
                        // console.log(
                        //   'media modifier : class - classes are in use'
                        //     .bgMagenta
                        // );
                        ...
                        class_array.forEach(function (item, item_index) {
                          // console.log(
                          //   'media modifier : class - individual class found:'
                          //     .bgMagenta,
                          //   item.trim()
                          // );
                        ...
                        // console.log(
                        //   'media modifier : class - final class string:'
                        //     .bgMagenta,
                        //   final_class
                        // );
                      }
                      if (modifier.startsWith('children[') === true) {
                        if (property === 'flex-grid') {
                          ...
                          // console.log(
                          //   'media modifier : children - children are in use'
                          //     .bgMagenta
                          // );
                          ...
                          child_array.forEach(function (item, item_index) {
                            // console.log(
                            //   'media modifier : children - individual child found:'
                            //     .bgMagenta,
                            //   item.trim()
                            // );
                          ...
                          // console.log(
                          //   'media modifier : children - final children array:'
                          //     .bgMagenta,
                          //   final_children
                          // );
                        }
