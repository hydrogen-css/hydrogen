          ...
          if (property == 'custom') {
            ...
            if (finalColor == null || finalColor == undefined) {
              console.error(
                ...
                parsedValues[0].red +
                '"'.red,
                'is an invalid color for ' + 'bg-color'.underline + '.'
              );
              falseAttribute = true;
            } else {
            ...
            if (parsedValues.length == 1 || parsedValues.length == 3) {
              ...
              if (parsedValues.length == 2) {
                ...
                // Get the color or gradient
                var borderColor = parseColor(argv, property, parsedValues[3]);
                // Log an error if the color comes back wrong, otherwise build the CSS
                if (borderColor == null || borderColor == undefined) {
                  console.error(
                    ...
                    parsedValues[3].red +
                    '"'.red,
                    'is an invalid color for ' + 'border'.underline + '.'
                  );
                  falseAttribute = true;
                } else {
                  if (borderColor.type == 'solid') {
                    // Build the CSS
                    if (parsedValues[0] == 'all') {
                      // Build the string 1px solid black
                      cssString = '{border: ' + borderWidth + ' ' + parsedValues[2] + ' ' + borderColor.color + ';transition: all 0.2s ease;}';
                      // Add the final CSS to the output file
                      valueCSS = [
                        cssSelector + cssString
                      ];
                      ...
                      // Build the string
                      cssString = '{border-top: ' + borderWidth + ' ' + parsedValues[2] + ' ' + borderColor.color + ';border-bottom: ' + borderWidth + ' ' + parsedValues[2] + ' ' + borderColor.color + ';transition: all 0.2s ease;}';
                      // Add the final CSS to the output file
                      valueCSS = [
                        '[data-h2-border*="all"]' + cssSelector + ',',
                        cssSelector + cssString
                      ...
                      // Build the string
                      cssString = '{border-left: ' + borderWidth + ' ' + parsedValues[2] + ' ' + borderColor.color + ';border-right: ' + borderWidth + ' ' + parsedValues[2] + ' ' + borderColor.color + ';transition: all 0.2s ease;}';
                      // Add the final CSS to the output file
                      valueCSS = [
                        '[data-h2-border*="all"]' + cssSelector + ',',
                        cssSelector + cssString
                      ...
                      // Build the string
                      cssString = '{border-top: ' + borderWidth + ' ' + parsedValues[2] + ' ' + borderColor.color + ';transition: all 0.2s ease;}';
                      // Add the final CSS to the output file
                      valueCSS = [
                        '[data-h2-border*="all"]' + cssSelector + ',',
                        '[data-h2-border*="' + mediaQuery + '(top-bottom"]' + cssSelector + ',',
                      ...
                      // Build the string
                      cssString = '{border-right: ' + borderWidth + ' ' + parsedValues[2] + ' ' + borderColor.color + ';transition: all 0.2s ease;}';
                      // Add the final CSS to the output file
                      valueCSS = [
                        '[data-h2-border*="all"]' + cssSelector + ',',
                        '[data-h2-border*="' + mediaQuery + '(right-left"]' + cssSelector + ',',
                      ...
                      // Build the string
                      cssString = '{border-bottom: ' + borderWidth + ' ' + parsedValues[2] + ' ' + borderColor.color + ';transition: all 0.2s ease;}';
                      // Add the final CSS to the output file
                      valueCSS = [
                        '[data-h2-border*="all"]' + cssSelector + ',',
                        '[data-h2-border*="' + mediaQuery + '(top-bottom"]' + cssSelector + ',',
                      ...
                      // Build the string
                      cssString = '{border-left: ' + borderWidth + ' ' + parsedValues[2] + ' ' + borderColor.color + ';transition: all 0.2s ease;}';
                      // Add the final CSS to the output file
                      valueCSS = [
                        '[data-h2-border*="all"]' + cssSelector + ',',
                        '[data-h2-border*="' + mediaQuery + '(right-left"]' + cssSelector + ',',
                  ...
                  } else if (borderColor.type == 'gradient') {
                    console.error(
                      '⛔ [' + 'Hydrogen'.magenta + ']',
                      'gradients'.red,
                      'are not supported by ' + 'border'.underline + '.'
                    );
                    falseAttribute = true;
                  }
                }
            ...
            // Flex grids accept 3 values
              ...
              // parsedValues[3] = optional row gap/gutter
            // Assemble CSS
            // Item alignment
            ...
            // Produce CSS string
            if (parsedValues[3] == null || parsedValues[3] == undefined) {
              // The user has specified a single gap value
              cssString = '{align-items: ' + itemAlignment + ';display: flex;flex-wrap: wrap; --h2-grid-gap: ' + itemGap + ';gap: var(--h2-grid-gap);' + wrapperPadding + '}';
            } else {
              // The user has specified two gap values, the first should be column, the second row
              // Find row gap
              var rowGap = parsedValues[3];
              for (const [key, value] of Object.entries(whitespaceMap)) {
                if (parsedValues[3] == key) {
                  rowGap = value;
                }
              }
              if (parsedValues[3] == '0' || 
              ...
              cssString = '{align-items: ' + itemAlignment + ';display: flex;flex-wrap: wrap; --h2-grid-gap: ' + itemGap + ';column-gap: var(--h2-grid-gap);row-gap: ' + rowGap + ';' + wrapperPadding + '}';
            }
            // Add the final CSS to the output file
            valueCSS = [
              cssSelector + cssString
            ...
            if (parsedValues[0] == 'auto') {
              ...
              if (firstColumn != null && secondColumn != null) {
                ...
                console.error(
                  ...
                  parsedValues[0].red +
                  '"'.red,
                  'is an invalid color for ' + 'flex-item'.underline + '. Please specify XofY for columns, auto, initial, or fill.'
                );
                falseAttribute = true;
              }
            }
            ...
            // Gap accepts 1 or 2 values
              // parsedValues[0] = gap value
              // parsedValues[1] = optional all, row, or column
            // Check if value is a key value based on line gap
            var gap = parsedValues[0];
            for (const [key, value] of Object.entries(whitespaceMap)) {
              if (parsedValues[0] == key) {
                gap = value;
              }
            }
            if (parsedValues[0] == '0' || 
            ...
            // Assemble CSS
            var cssContent;
            if (parsedValues[1] == null || parsedValues[1] == undefined) {
              // The user only specified one option, so they want the gap value for both row and column
              cssContent = '{gap: ' + gap + ';transition: 0.2s ease all;}';
            } else {
              // The user has specified all, row, or column
              if (parsedValues[1] == 'all' || parsedValues[1] == 'both') {
                cssContent = '{gap: ' + gap + ';transition: 0.2s ease all;}';
              } else if (parsedValues[1] == 'row') {
                cssContent = '{row-gap: ' + gap + ';transition: 0.2s ease all;}';
              } else if (parsedValues[1] == 'column') {
                ...
                console.error(
                  ...
                  parsedValues[1].red +
                  '"'.red,
                  'is an invalid orientation option for ' + 'gap'.underline + '. Please use all, row, or column.'
                );
                falseAttribute = true;
              }
            }
            ...
            console.log(
              ...
              property[0].red + 
              '"'.red,
              'is not an available Hydrogen attribute.'
            );
            falseAttribute = true;
          }
