        ...
        values.forEach(function(value) {
          ...
          if (queryMatch != null) {
            ...
            if (config.mediaWarnings != false) {
              console.log('[WARNING]'.yellow, 'Hydrogen: there\'s no matching media query in the media query map for the query ' + mediaValue[0].yellow + '.');
            }
          }
        }); 
      }
...
function successMessage(done) {
  console.log('[SUCCESS].green', 'Hydrogen: you\'ve successfully compiled Hydrogen. Hydrogen is watching for changes to your hydrogen.config.json file, as well as your markup.');
  done();
}
