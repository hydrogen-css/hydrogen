 ...
 * @returns {ColorOutput | false} An object with color information, including the usable color string
 */
  ...
  try {
    ...
    if (color_string) {
      ...
      if (
        ...
        let match = false;
        settings.runtime.themes[theme].colors.forEach(function (color_setting) {
          if (color_array.includes(color_setting.key) === true) {
        ...
        if (match) {
          ...
          if (color_array.length === 1) {
            ...
            color_array.forEach(function (color_item) {
              ...
              if (match[mode].modifiers && match[mode].modifiers.length > 0) {
      ...
      if (
        ...
        if (
          ...
          settings.runtime.themes[theme].gradients.forEach(function (
            gradient_setting
          ) {
