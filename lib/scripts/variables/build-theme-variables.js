        ...
        settings.themes[theme].typography.forEach(function (type) {
          ...
          if (type.query === 'base') {
            ...
            if (type.line_heights && type.line_heights.copy) {
              units = units + '--h2-base-line-height: ' + type.line_heights.copy + ';\n';
              units = units + '--h2-base-whitespace: ' + type.line_heights.copy + ';\n';
            } else if (type.line_heights) {
              units = units + '--h2-base-line-height: ' + dlh + ';\n';
              units = units + '--h2-base-whitespace: ' + dlh + ';\n';
            ...
            typography = typography + build_typography_variables(settings, type);
          }
        });
      }
    }
