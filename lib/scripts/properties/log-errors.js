 ...
 * @param {} values
 */
function property_option_error(settings, property, instance, option, values) {
 ...
 * @param {} options
 */
function property_invalid_option_count(
  settings,
  property,
  instance,
  values,
 ...
 * @param {Error} error
 */
function property_error_catch(settings, property, instance, error) {
  log_message(settings, {
    type: 'error',
    step: 'Building ' + property + ' CSS',
    message: error,
...
function get_syntax_errors(
  ...
  try {
    ...
    property_error_catch(settings, property, instance, error);
    return false;
  }
}
 ...
 * @returns
 */
function get_option_count_errors(
  settings,
  prop_data,
  property,
  instance,
