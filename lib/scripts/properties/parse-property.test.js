...
let { parse_property } = require('./parse-property');

/*
  Test list
  - The function correctly returns a valid CSS string when passed a property containing a mix of CSS and Hydrogen color and space values
  - The function correctly returns a valid CSS string when passed multiple Hydrogen space multipliers
*/
...
function test1() {
  return new Promise((resolve, reject) => {
    let test_name = '1 - Standard border-top';
    let settings = settings_data;
    let property = 'border-top';
    /** @type {Property} */
    let prop_data;
    property_data.properties.forEach((prop) => {
      if (prop.id === 'border-top') {
        prop_data = prop;
      }
    });
    /** @type {Instance} */
    let prop_instance = {
      attribute: 'data-h2-border-top="base(x5 solid primary.dark.50)"',
      files: ['test/path'],
      values: [],
    };
    /** @type {Value} */
    let prop_value = {
      ...
      options: ['x5 solid primary.dark.50'],
      prefix: 'base',
      query: 'base(x5 solid primary.dark.50)',
      selectors: ['[data-h2-border-top*="base(x5 solid primary.dark.50)"]'],
    };
    log_message({
      type: 'system',
      step: 'Running test...',
    ...
    try {
      ...
      if (
        test[0] ===
        '[data-h2-border-top*="base(x5 solid primary.dark.50)"]{border-top: calc((5 * var(--h2-base-whitespace)) * 1rem) solid rgba(var(--h2-color-primary-dark), 0.5);}'
      ) {
...
function test2() {
  return new Promise((resolve, reject) => {
    let test_name = '2 - Complex margins';
    let settings = settings_data;
    let property = 'margin';
    /** @type {Property} */
    let prop_data;
    ...
    /** @type {Instance} */
    let prop_instance = {
      attribute: 'data-h2-margin="base(x4 x.6 x1 x.67)"',
      files: ['test/path'],
      values: [],
    };
    /** @type {Value} */
    let prop_value = {
      ...
      options: ['x4 x.6 x1 x.67'],
      prefix: 'base',
      query: 'base(x4 x.6 x1 x.67)',
      selectors: ['[data-h2-margin*="base(x4 x1.6 x1 x.67)"]'],
    };
    log_message({
      type: 'system',
      step: 'Running test...',
    ...
    try {
      ...
      if (
        test[0] ===
        '[data-h2-margin*="base(x4 x1.6 x1 x.67)"]{margin: calc((4 * var(--h2-base-whitespace)) * 1rem) calc((.6 * var(--h2-base-whitespace)) * 1rem) calc((1 * var(--h2-base-whitespace)) * 1rem) calc((.67 * var(--h2-base-whitespace)) * 1rem);}'
      ) {
        resolve({ test_name: test_name });
      } else {
        reject({ test_name: test_name });
...
function test3() {
  return new Promise((resolve, reject) => {
    let test_name = '3 - Standard outline';
    let settings = settings_data;
    ...
    /** @type {Instance} */
    let prop_instance = {
      attribute: 'data-h2-outline="base(thick double secondary.lighter)"',
      files: ['test/path'],
      values: [],
    };
    /** @type {Value} */
    let prop_value = {
      ...
      options: ['thick double secondary.lighter'],
      prefix: 'base',
      query: 'base(thick double secondary.lighter)',
      selectors: ['[data-h2-outline*="base(thick double secondary.lighter)"]'],
    };
    log_message({
      type: 'system',
      step: 'Running test...',
    ...
    try {
      ...
      if (
        test[0] ===
        '[data-h2-outline*="base(thick double secondary.lighter)"]{outline: thick double rgba(var(--h2-color-secondary-lighter), 1);}'
      ) {
        resolve({ test_name: test_name });
      } else {
        reject({ test_name: test_name });
...
function test4() {
  return new Promise((resolve, reject) => {
    let test_name = '4 - Background gradients';
    let settings = settings_data;
    ...
    /** @type {Instance} */
    let prop_instance = {
      attribute: 'data-h2-background="base(primaryRadial)"',
      files: ['test/path'],
      values: [],
    };
    /** @type {Value} */
    let prop_value = {
      ...
      options: ['primaryRadial'],
      prefix: 'base',
      query: 'base(primaryRadial)',
      selectors: ['[data-h2-background*="base(primaryRadial)"]'],
    };
    log_message({
      type: 'system',
      step: 'Running test...',
    ...
    try {
      ...
      if (
        test[0] ===
        '[data-h2-background*="base(primaryRadial)"]{background: var(--h2-gradient-primaryRadial);}'
      ) {
        resolve({ test_name: test_name });
      } else {
        reject({ test_name: test_name });
