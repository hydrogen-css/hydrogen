// Hydrogen: Justify content parsing
'use strict';
...
/**
 * Parse data-h2-justify-content and return CSS
 *
 * Justify content is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_justify_content(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "justification" value for justify-content only accepts CSS justify-content values."';
    var value_count_error_message =
      "justify-content accepts 1 value (justification), and you've specified " +
      values.length +
      '.';
    // =========================================================================
