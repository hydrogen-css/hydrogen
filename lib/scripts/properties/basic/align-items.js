...
/**
 * Parse data-h2-align-items and return CSS
 *
 * Align items is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_align_items(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "alignment" value for align-items only accepts CSS align-items values."';
    var value_count_error_message =
      "align-items accepts 1 value (alignment), and you've specified " +
      values.length +
      '.';
    // =========================================================================
