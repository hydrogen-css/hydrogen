...
/**
 * Parse data-h2-cursor and return CSS
 *
 * Cursor is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_cursor(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "cursor" value for cursor only accepts CSS cursor values."';
    var value_count_error_message =
      "cursor accepts 1 value (cursor), and you've specified " +
      values.length +
      '.';
    // =========================================================================
