...
/**
 * Parse data-h2-display and return CSS
 *
 * Display is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_display(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "display" value for display only accepts CSS display values."';
    var value_count_error_message =
      "display accepts 1 value (display), and you've specified " +
      values.length +
      '.';
    // =========================================================================
