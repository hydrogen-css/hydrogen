...
/**
 * Parse data-h2-text-align and return CSS
 *
 * Text align is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_text_align(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "alignment" value for text-align only accepts CSS text-align values."';
    var value_count_error_message =
      "text-align accepts 1 value (alignment), and you've specified " +
      values.length +
      '.';
    // =========================================================================
