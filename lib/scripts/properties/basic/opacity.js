...
/**
 * Parse data-h2-opacity and return CSS
 *
 * Opacity is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_opacity(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "opacity" value for opacity only accepts decimals."';
    var value_count_error_message =
      "opacity accepts 1 value (opacity), and you've specified " +
      values.length +
      '.';
    // =========================================================================
