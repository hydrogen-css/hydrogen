...
/**
 * Parse data-h2-list-style and return CSS
 *
 * List style is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_list_style(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "style" value for list-style only accepts CSS list-style values."';
    var value_count_error_message =
      "list-style accepts 1 value (style), and you've specified " +
      values.length +
      '.';
    // =========================================================================
