// Hydrogen: Align content parsing
'use strict';
...
/**
 * Parse data-h2-align-content and return CSS
 *
 * Align content is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_align_content(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "alignment" value for align-content only accepts CSS align-content values."';
    var value_count_error_message =
      "align-content accepts 1 value (alignment), and you've specified " +
      values.length +
      '.';
    // =========================================================================
