// Hydrogen: Text transform parsing
'use strict';
...
/**
 * Parse data-h2-text-transform and return CSS
 *
 * Text transform is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_text_transform(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "transformation" value for text-transform only accepts CSS text-transform values."';
    var value_count_error_message =
      "text-transform accepts 1 value (transformation), and you've specified " +
      values.length +
      '.';
    // =========================================================================
