...
/**
 * Parse data-h2-order and return CSS
 *
 * Order is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_order(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "order" value for order only accepts numbers."';
    var value_count_error_message =
      "order accepts 1 value (order), and you've specified " +
      values.length +
      '.';
    // =========================================================================
