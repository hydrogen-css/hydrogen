...
/**
 * Parse data-h2-grid-column and return CSS
 *
 * Grid column is a basic property and leverages the basic parser function
 *
 ...
 */
function parse_grid_column(instance, property, selector, values) {
  try {
    // =========================================================================
    // Generate a custom error messages
    var syntax_error_message =
      'the "span" value for grid-column only accepts CSS grid-column values."';
    var value_count_error_message =
      "grid-column accepts 1 value (span), and you've specified " +
      values.length +
      '.';
    // =========================================================================
