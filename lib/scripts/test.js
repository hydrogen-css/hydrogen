...
// Todo: gradient fallbacks for font color should set the font color to the first color stop in the gradient - this will require a more complex gradient map that provides access to the fallback color.
    ...
    hydrogenAttributes.forEach(function(attribute) {
      ...
      values.forEach(function(value) {
        ...
        if (property == 'custom') {
          ...
          // User can't set any config values for align content
          // Assemble CSS
          var cssContent = '{align-content: ' + alignment + ';}';
          ...
          // User can't set any config values for align content
          // Assemble CSS
          var cssContent = '{align-items: ' + alignment + ';}';
          // Add the final CSS to the output file
          var valueCSS = cssSelector + cssContent;
          ...
          // User can't set any config values for align self
          // Assemble CSS
          var cssContent = '{align-self: ' + alignment + ';}';
          // Add the final CSS to the output file
          var valueCSS = cssSelector + cssContent;
          ...
          // Assemble CSS
          var cssContent = '{' + alignmentCSSContent + 'max-width: ' + container + ';}';
          // Add to media css string, and only assemble the hydrogen file at the end, with the correct order for queries by looping through them
          // Add the final CSS to the output file
          var valueCSS = cssSelector + cssContent;
          ...
          // User can't set any config values for position
          // Assemble CSS
          var cssContent = '{position: ' + position + ';}';
          // Add the final CSS to the output file
          var valueCSS = cssSelector + cssContent;
