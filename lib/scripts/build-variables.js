...
var { h2_error_detail, h2_timer } = require('./logs');
...
function build_variables() {
  try {
    ...
    //
    const settings = h2_load_settings();
    const typography_settings = buildTypography();
    //
    ...
    typography_settings.forEach(function (
      ...
      if (
        ...
        if (
          ...
          settings.colors.forEach(function (
            color_setting,
            color_setting_index
          ) {
      ...
      if (
        ...
        if (settings.containers != null && settings.containers != []) {
          settings.containers.forEach(function (
            container_setting,
      ...
      if (
        ...
        // Build the variables .................................................
        //
        if (settings.gradients != null && settings.gradients != []) {
          settings.gradients.forEach(function (
            gradient_setting,
      ...
      if (
        ...
        if (settings.radius != null && settings.radius != []) {
          settings.radius.forEach(function (
            radius_setting,
      ...
      if (
        ...
        if (settings.shadows != null && settings.shadows != []) {
          settings.shadows.forEach(function (
            shadow_setting,
      ...
      if (
        ...
        if (settings.transitions != null && settings.transitions != {}) {
          ...
          if (settings.transitions.durations != null) {
            settings.transitions.durations.forEach(function (
              duration_setting,
          ...
          if (settings.transitions.functions != null) {
            settings.transitions.functions.forEach(function (
              function_setting,
          ...
          if (settings.transitions.delays != null) {
            settings.transitions.delays.forEach(function (
              delay_setting,
              delay_setting_index
            ) {
              variable_string =
    ...
    //   'internal',
    //   null,
    //   path.join(process.cwd() + '/hydrogen.vars.css'),
    //   error
    // );
    return false;
  }
...
function write_variable_file() {
  try {
    ...
    // Load the variables ======================================================
    //
    let css_variables = build_variables();
    //
