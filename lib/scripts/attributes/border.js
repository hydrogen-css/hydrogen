  ...
  try {
    ...
    if (values.length == 2) {
      ...
      if (sides == 'all') {
        ...
        // Assemble the CSS array
        var borderCSS = ['[data-h2-border*="' + mediaQuery + '(all"]' + selector + ',', selector + cssString];
        // Return the array
        return borderCSS;
        ...
        // Assemble the CSS array
        var borderCSS = ['[data-h2-border*="' + mediaQuery + '(all"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(top-bottom"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(bottom-top"]' + selector + ',', selector + cssString];
        // Return the array
        return borderCSS;
      } else if (sides == 'right') {
        ...
        // Assemble the CSS array
        var borderCSS = ['[data-h2-border*="' + mediaQuery + '(all"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(right-left"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(left-right"]' + selector + ',', selector + cssString];
        // Return the array
        return borderCSS;
      ...
      if (sides == 'all') {
        // The border should be applied to all 4 sides
        var cssString = '{border: ' + borderWidth + ' ' + borderStyle + ' ' + borderColor.color + ';}';
        // Assemble the CSS array
        var borderCSS = [selector + cssString];
        // Return the array
        return borderCSS;
        ...
        // The border should be applied to top and bottom
        var cssString = '{border-top: ' + borderWidth + ' ' + borderStyle + ' ' + borderColor.color + ';border-bottom: ' + borderWidth + ' ' + borderStyle + ' ' + borderColor.color + ';}';
        // Assemble the CSS array
        var borderCSS = ['[data-h2-border*="' + mediaQuery + '(all"]' + selector + ',', selector + cssString];
        // Return the array
        return borderCSS;
        ...
        // The border should be applied to right and left
        var cssString = '{border-right: ' + borderWidth + ' ' + borderStyle + ' ' + borderColor.color + ';border-left: ' + borderWidth + ' ' + borderStyle + ' ' + borderColor.color + ';}';
        // Assemble the CSS array
        var borderCSS = ['[data-h2-border*="' + mediaQuery + '(all"]' + selector + ',', selector + cssString];
        // Return the array
        return borderCSS;
        ...
        // The border should be applied to the top
        var cssString = '{border-top: ' + borderWidth + ' ' + borderStyle + ' ' + borderColor.color + ';}';
        // Assemble the CSS array
        var borderCSS = ['[data-h2-border*="' + mediaQuery + '(all"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(top-bottom"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(bottom-top"]' + selector + ',', selector + cssString];
        // Return the array
        return borderCSS;
        ...
        // The border should be applied to the right
        var cssString = '{border-right: ' + borderWidth + ' ' + borderStyle + ' ' + borderColor.color + ';}';
        // Assemble the CSS array
        var borderCSS = ['[data-h2-border*="' + mediaQuery + '(all"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(right-left"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(left-right"]' + selector + ',', selector + cssString];
        // Return the array
        return borderCSS;
        ...
        // The border should be applied to the bottom
        var cssString = '{border-bottom: ' + borderWidth + ' ' + borderStyle + ' ' + borderColor.color + ';}';
        // Assemble the CSS array
        var borderCSS = ['[data-h2-border*="' + mediaQuery + '(all"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(top-bottom"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(bottom-top"]' + selector + ',', selector + cssString];
        // Return the array
        return borderCSS;
        ...
        // The border should be applied to the left
        var cssString = '{border-left: ' + borderWidth + ' ' + borderStyle + ' ' + borderColor.color + ';}';
        // Assemble the CSS array
        var borderCSS = ['[data-h2-border*="' + mediaQuery + '(all"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(right-left"]' + selector + ',', '[data-h2-border*="' + mediaQuery + '(left-right"]' + selector + ',', selector + cssString];
        // Return the array
        return borderCSS;
