  ...
  try {
    ...
    if (values.length >= 1) {
      ...
      value1Err =
        ...
        value1.red +
        '"'.red +
        ' is an invalid property option for ' +
    ...
    if (values.length >= 2) {
      ...
      value2Err =
        ...
        value2.toString().red +
        '"'.red +
        ' is an invalid duration option for ' +
        property[0].underline +
        '.';
    }
    ...
    if (values.length >= 3) {
      ...
      value3Err =
        ...
        value3.toString().red +
        '"'.red +
        ' is an invalid function option for ' +
        property[0].underline +
        '.';
    }
    ...
    if (values.length >= 4) {
      ...
      value4Err =
        ...
        value4.toString().red +
        '"'.red +
        ' is an invalid delay option for ' +
        property[0].underline +
        '.';
    }
    ...
    if (values.length == 2) {
      ...
      var errorMessage =
        ...
        property[0].red +
        '"'.red +
        " accepts 2, 3, or 4 values, and you've specified " +
        values.length +
        '.';
