  ...
  try {
    ...
    if (values.length == 3) {
      ...
      if (wrapperPadding == null) {
        ...
        var cssString;
        if (itemGutter == 0 || itemGutter == 'none') {
          cssString = '{align-items: ' + alignment + ';display: flex;flex-wrap: wrap; --h2-grid-gap: ' + itemGutter + ';--h2-item-gap: 1px;--h2-item-zero-catch: 1px;gap: var(--h2-grid-gap);padding: ' + wrapperPadding + ';}';
        } else {
          cssString = '{align-items: ' + alignment + ';display: flex;flex-wrap: wrap; --h2-grid-gap: ' + itemGutter + ';--h2-item-gap: ' + itemGutter + ';--h2-item-zero-catch: 0rem;gap: var(--h2-grid-gap);padding: ' + wrapperPadding + ';}';
        }
      ...
      if (wrapperPadding == null) {
        ...
        var cssString;
        if (itemGutter == 0 || itemGutter == 'none') {
          cssString = '{align-items: ' + alignment + ';display: flex;flex-wrap: wrap; --h2-grid-gap: ' + itemGutter + ';--h2-item-gap: 1px;--h2-item-zero-catch: 1px;column-gap: var(--h2-grid-gap);row-gap: ' + rowGutter + ';padding: ' + wrapperPadding + ';}';
        } else {
          cssString = '{align-items: ' + alignment + ';display: flex;flex-wrap: wrap; --h2-grid-gap: ' + itemGutter + ';--h2-item-gap: ' + itemGutter + ';--h2-item-zero-catch: 0rem;column-gap: var(--h2-grid-gap);row-gap: ' + rowGutter + ';padding: ' + wrapperPadding + ';}';
        }
        // Assemble the CSS array
        var attributeCSS = [selector + cssString];
        // Return the array
