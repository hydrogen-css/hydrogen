  ...
  try {
    ...
    if (values.length == 3) {
      ...
      if (wrapperPadding == null) {
        ...
        var attributeCSS = [selector + cssString, selector + ' > [data-h2-flex-item]{margin: var(--h2-row-gap) 0 0 var(--h2-column-gap);}', selector + '{pointer-events: none;}', selector + ' > * {pointer-events: auto;}'];
        // Return the array
        return attributeCSS;
      }
