    ...
    if (values.length == 1) {
      if (bgColor == null) {
        ...
        if (bgColor.type == 'solid') {
          cssString = '{background-color: ' + bgColor.color + ";content: ' ';display: block;height: 100%;position: absolute;top: 0;left: 0;transition: all 0.2s ease;width: 100%;transition: 0.2s ease all;}";
        } else if (bgColor.type == 'gradient') {
          cssString = '{background-color: ' + bgColor.fallback + ';background-image: ' + bgColor.color + ";content: ' ';display: block;height: 100%;position: absolute;top: 0;left: 0;transition: all 0.2s ease;width: 100%;transition: 0.2s ease all;}";
        }
      }
      ...
      if (bgColor == null) {
        ...
        if (bgColor.type == 'solid') {
          cssString = '{background-color: ' + bgColor.color + ';opacity: ' + opacity + ";content: ' ';display: block;height: 100%;position: absolute;top: 0;left: 0;transition: all 0.2s ease;width: 100%;transition: 0.2s ease all;}";
        } else if (bgColor.type == 'gradient') {
          cssString = '{background-color: ' + bgColor.fallback + ';background-image: ' + bgColor.color + ';opacity: ' + opacity + ";content: ' ';display: block;height: 100%;position: absolute;top: 0;left: 0;transition: all 0.2s ease;width: 100%;transition: 0.2s ease all;}";
        }
      }
    } else {
