 ...
 * @returns {Promise<PropertyModel>} The properties model populated with parsed data for all attributes used
 */
            ...
            if (attributes.length > 0) {
              ...
              attributes.forEach(function (match) {
                ...
                if (queries) {
                  ...
                  if (
                    !Object.keys(property_data.attributes).includes(property)
                  ) {
