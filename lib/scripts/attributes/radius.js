 ...
 */
function parseRadius(property, selector, values) {
  try {
    ...
    if (values.length >= 1) {
      ...
      value1 = parseWhitespace(property, value1);
      value1Err =
        '"'.red +
        value1.red +
        '"'.red +
    ...
    if (values.length >= 2) {
      ...
      value2 = parseWhitespace(property, value2);
      value2Err =
        '"'.red +
        value2.toString().red +
        '"'.red +
    ...
    if (values.length >= 3) {
      ...
      value3 = parseWhitespace(property, value3);
      value3Err =
        '"'.red +
        value3.toString().red +
        '"'.red +
    ...
    if (values.length >= 4) {
      ...
      value4 = parseWhitespace(property, value4);
      value4Err =
        '"'.red +
        value4.toString().red +
        '"'.red +
    ...
    if (values.length == 1) {
      ...
      var errorMessage =
        ...
        property[0].red +
        '"'.red +
        " accepts 1, 2, or 4 values, and you've specified " +
        values.length +
        '.';
