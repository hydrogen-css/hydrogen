...
function createUtilityVariables(
  ...
  if (utilityConfigKey == 'heights' || utilityConfigKey == 'widths') {
    ...
    if (
      ...
      whitespaceScaleConfig = config.fontBaseLineHeight;
    } else {
      whitespaceScaleConfig = defaults.fontBaseLineHeight;
    }
    // Create the variables
    var xquarter = formatPrefix + 'h2-' + variableLabel + '-xquarter: ' + (whitespaceScaleConfig * 0.25) + 'rem;\n';
    var xhalf = formatPrefix + 'h2-' + variableLabel + '-xhalf: ' + (whitespaceScaleConfig * 0.5) + 'rem;\n';
    var x1 = formatPrefix + 'h2-' + variableLabel + '-x1: ' + (whitespaceScaleConfig * 1) + 'rem;\n';
    var x2 = formatPrefix + 'h2-' + variableLabel + '-x2: ' + (whitespaceScaleConfig * 2) + 'rem;\n';
    var x3 = formatPrefix + 'h2-' + variableLabel + '-x3: ' + (whitespaceScaleConfig * 3) + 'rem;\n';
    var x4 = formatPrefix + 'h2-' + variableLabel + '-x4: ' + (whitespaceScaleConfig * 4) + 'rem;\n';
    var x5 = formatPrefix + 'h2-' + variableLabel + '-x5: ' + (whitespaceScaleConfig * 5) + 'rem;\n';
    utilityVariables = utilityVariables.concat(xquarter, xhalf, x1, x2, x3, x4, x5);
  }
