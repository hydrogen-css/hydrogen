...
/**
 * Generates a list of font scale variables (e.g. h1-h6, p, caption)
...
function setFontScaleVariables(env, format) {
  try {
    ...
    var fontScaleBase = 1;
    var fontScaleBaseString =
      formatPrefix + 'h2-font-size-base: ' + fontScaleBase + 'rem;\n';
    var fontScaleCaption = fontScaleBase / fontScaleConfig;
    var fontScaleCaptionString =
      formatPrefix + 'h2-font-size-caption: ' + fontScaleCaption + 'rem;\n';
    var fontScaleH6 = fontScaleBase * fontScaleConfig;
    var fontScaleH6String =
      formatPrefix + 'h2-font-size-h6: ' + fontScaleH6 + 'rem;\n';
    var fontScaleH5 = fontScaleH6 * fontScaleConfig;
    var fontScaleH5String =
      formatPrefix + 'h2-font-size-h5: ' + fontScaleH5 + 'rem;\n';
    var fontScaleH4 = fontScaleH5 * fontScaleConfig;
    var fontScaleH4String =
      formatPrefix + 'h2-font-size-h4: ' + fontScaleH4 + 'rem;\n';
    var fontScaleH3 = fontScaleH4 * fontScaleConfig;
    var fontScaleH3String =
      formatPrefix + 'h2-font-size-h3: ' + fontScaleH3 + 'rem;\n';
    var fontScaleH2 = fontScaleH3 * fontScaleConfig;
    var fontScaleH2String =
      formatPrefix + 'h2-font-size-h2: ' + fontScaleH2 + 'rem;\n';
    var fontScaleH1 = fontScaleH2 * fontScaleConfig;
    var fontScaleH1String =
      formatPrefix + 'h2-font-size-h1: ' + fontScaleH1 + 'rem;\n';
    fontScaleVariables =
      fontScaleVariables +
      fontScaleH1String +
      fontScaleH2String +
