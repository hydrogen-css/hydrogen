  ...
  try {
    ...
    do {
      ...
      if (lineHeightMultiple < fontScaleH1) {
        ...
        h1LineHeight = formatPrefix + 'h2-line-height-h1: ' +  lineHeightMultiple + ';\n';
      } 
    ...
    do {
      ...
      if (lineHeightMultiple < fontScaleH2) {
        ...
        h2LineHeight = formatPrefix + 'h2-line-height-h2: ' +  lineHeightMultiple + ';\n';
      } 
    ...
    do {
      ...
      if (lineHeightMultiple < fontScaleH3) {
        ...
        h3LineHeight = formatPrefix + 'h2-line-height-h3: ' +  lineHeightMultiple + ';\n';
      } 
    ...
    do {
      ...
      if (lineHeightMultiple < fontScaleH4) {
        ...
        h4LineHeight = formatPrefix + 'h2-line-height-h4: ' +  lineHeightMultiple + ';\n';
      } 
    ...
    do {
      ...
      if (lineHeightMultiple < fontScaleH5) {
        ...
        h5LineHeight = formatPrefix + 'h2-line-height-h5: ' +  lineHeightMultiple + ';\n';
      } 
    ...
    do {
      ...
      if (lineHeightMultiple < fontScaleH6) {
        ...
        h6LineHeight = formatPrefix + 'h2-line-height-h6: ' +  lineHeightMultiple + ';\n';
      } 
