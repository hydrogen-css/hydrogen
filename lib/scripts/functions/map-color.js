    ...
    colorSettings.forEach(function (color) {
      ...
      if (
        ...
        if (color.variants.light) {
          ...
          //   .lightness(80)
          //   .rgb();
          var newLightColor = lightenBy(Color(color.color), 0.5);
        ...
        if (color.variants.dark) {
          ...
          // Create the color variant
          // var newDarkColor = Color(color.color).lightness(20).rgb();
          var newDarkColor = darkenBy(Color(color.color), 0.5).rgb();
          // Set the generated definition
          colorVariantVariables = colorVariantVariables.concat(
            formatPrefix +
              'h2-color-' +
    ...
    if (color.variants) {
      if (
        ...
        if (color.variants.light) {
          ...
          //   .lightness(80)
          //   .rgb();
          var newLightColor = lightenBy(Color(color.color), 0.5).rgb();
          // Set the generated definition
          colorLightString =
      ...
      // Create the color variant
      // var newLightColor = Color(color.color).lightness(80).rgb();
      var newLightColor = lightenBy(Color(color.color), 0.5).rgb();
