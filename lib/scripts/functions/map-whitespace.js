...
function createWhitespaceSassVariables(env) {
  ...
  whitespaceVariables = whitespaceVariables.concat('$h2-margin-none: 0;\n$h2-margin-auto: auto;\n')
  // Create the whitespace scale for both margin and padding.
  var marginXXS = '$h2-margin-xxs: ' + (1 / whitespaceScaleConfig) / whitespaceScaleConfig + 'rem;\n';
  ...
  var marginL = '$h2-margin-l: ' + (1 * whitespaceScaleConfig) * whitespaceScaleConfig + 'rem;\n';
  var marginXL = '$h2-margin-xl: ' + ((1 * whitespaceScaleConfig) * whitespaceScaleConfig) * whitespaceScaleConfig + 'rem;\n';
  var marginXXL = '$h2-margin-xxl: ' + (((1 * whitespaceScaleConfig) * whitespaceScaleConfig) * whitespaceScaleConfig) * whitespaceScaleConfig + 'rem;\n';
  whitespaceVariables = whitespaceVariables + marginXXS + marginXS + marginS + marginM + marginL + marginXL + marginXXL;
  var negativeMarginXXS = '$h2-negative-margin-xxs: ' + ((1 / whitespaceScaleConfig) / whitespaceScaleConfig) * -1 + 'rem;\n';
  var negativeMarginXS = '$h2-negative-margin-xs: ' + (1 / whitespaceScaleConfig * -1) + 'rem;\n';
  var negativeMarginS = '$h2-negative-margin-s: -1rem;\n';
  var negativeMarginM = '$h2-negative-margin-m: ' + (1 * whitespaceScaleConfig) * -1 + 'rem;\n';
  var negativeMarginL = '$h2-negative-margin-l: ' + ((1 * whitespaceScaleConfig) * whitespaceScaleConfig) * -1 + 'rem;\n';
  var negativeMarginXL = '$h2-negative-margin-xl: ' + (((1 * whitespaceScaleConfig) * whitespaceScaleConfig) * whitespaceScaleConfig) * -1 + 'rem;\n';
  var negativeMarginXXL = '$h2-negative-margin-xxl: ' + ((((1 * whitespaceScaleConfig) * whitespaceScaleConfig) * whitespaceScaleConfig) * whitespaceScaleConfig * -1) + 'rem;\n';
  whitespaceVariables = whitespaceVariables + negativeMarginXXS + negativeMarginXS + negativeMarginS + negativeMarginM + negativeMarginL + negativeMarginXL + negativeMarginXXL;
  var paddingXXS = '$h2-padding-xxs: ' + (1 / whitespaceScaleConfig) / whitespaceScaleConfig + 'rem;\n';
  ...
  var paddingL = '$h2-padding-l: ' + (1 * whitespaceScaleConfig) * whitespaceScaleConfig + 'rem;\n';
  var paddingXL = '$h2-padding-xl: ' + ((1 * whitespaceScaleConfig) * whitespaceScaleConfig) * whitespaceScaleConfig + 'rem;\n';
  var paddingXXL = '$h2-padding-xxl: ' + (((1 * whitespaceScaleConfig) * whitespaceScaleConfig) * whitespaceScaleConfig) * whitespaceScaleConfig + 'rem;\n';
  whitespaceVariables = whitespaceVariables + paddingXXS + paddingXS + paddingS + paddingM + paddingL + paddingXL + paddingXXL;
