...
function loadRadiusMap(env) {
  ...
  // Assemble the map.
  var radiusMap =
    radiusMapStringStart + radiusMapStringContent + radiusMapStringEnd;
  // Return the map.
  return radiusMap;
}
...
function setRadiusMap(env) {
  ...
  if (env == 'dev') {
    ...
    return src(
      './node_modules/@hydrogen-design-system/hydrogen.css/lib/styles/maps/_map-radius.scss'
    )
      .pipe(footer(radiusMap))
