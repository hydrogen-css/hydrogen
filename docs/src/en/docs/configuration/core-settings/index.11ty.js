          ...
          items: [
            {
              ...
              items: [
                ...
                "The <code>browser_prefix_css</code> setting enables/disables whether <a href='https://lightningcss.dev/' title='Learn more about Lightning CSS in a new tab.' target='_blank'>Lightning CSS</a>' browser prefixing service is run on the final CSS output. Lightning provides helpful CSS browser prefixes to ensure compatibility across browsers.",
                "The <code>minify_css</code> setting enables/disables whether <a href='https://lightningcss.dev/' title='Learn more about Lightning CSS in a new tab.' target='_blank'>Lightning CSS</a>' minification service is run on the final CSS output. Lightning compresses the final output using a series of basic rules to ensure the output file size is as small as possible.",
                "The <code>export_variable_file</code> setting tells Hydrogen whether or not you want a CSS variable file exported to the output folder. <a href='/en/docs/variables' title='Learn more about the variables created when Hydrogen runs.'>Hydrogen's output includes these variables</a>, however, if you want to use the variables on a page that doesn't include Hydrogen, this file can be helpful.",
              ],
            },
            {
              type: 'code',
