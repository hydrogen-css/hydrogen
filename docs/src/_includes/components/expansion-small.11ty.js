...
function render(data, props) {
  ...
  return String.raw`
    <div class="${state_class}" data-h2-position="base(relative)"
      data-h2-display="
      ...
      <button
        ...
        <div data-h2-display="base(grid)" data-h2-grid-template-columns="base(x1 1fr)">
          ...
          <p data-h2-font-weight="base(700)" data-h2-text-align="base(left)">${props.label}</p>
        </div>
      </button>
